        ...
        <div class="grid-cell-1of5">
            <fieldset class="layui-elem-field loop notice">
                ...
                <div class="layui-field-box">
                    ...
                    <p style="font-size: medium;">开放时间: ${item.openTime}</p>
                    <p style="font-size: medium;">电话: ${item.mobile}</p>
                    <button class="layui-btn add-cart" style="margin-top: 10px;">加入购物车</button>
                    <input type="hidden" value="${item.id}">
                    <a href="/scenic/scenicDetail.action?id=${item.id}" class="layui-btn">查看详情</a>
                </div>
            </fieldset>
        </div>
    </c:forEach>
